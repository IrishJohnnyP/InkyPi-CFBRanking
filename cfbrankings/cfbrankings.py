...
class CfbRankings(BasePlugin):
    ...
    Features:
      ...
      - Two-column layout automatically ONLY when records are hidden and Top N > 15
      - Records automatically hidden when Top N > 20 to prevent crowding
      - Displays poll update date in local time with TZ abbreviation when available
    ...
    def generate_image(self, settings: Dict[str, Any], device_config):
        ...
        # Auto hide record when Top N > 20
        ...
        # Two-column ONLY when records are hidden and Top N > 15
        two_column = bool((not show_record) and top_n > 15)
        ...
        # Robust ranks extraction for different poll structures
    ...
    def _format_poll_date(self, poll: Dict[str, Any], poll_name: str, device_config) -> str:
        """Updated <Mon> <DD>, <YYYY> <H:MM> <AM/PM> <TZ?> • <Poll Name> (TZ optional)"""
    ...
    def _select_poll(self, data: Dict[str, Any], choice: str) -> Optional[Dict[str, Any]]:
        ...
        # AUTO: most recent among known poll types
